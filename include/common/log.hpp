...
public:
  ...
  static void WARN(const std::string& msg) {
    std::string s;
    s += std::string("[WARN] [") + get_curr_time_as_string() + std::string("]: ") + msg;
    std::cout << tColors.YELLOW << s << tColors.NC << std::endl;
  }

  static void ERROR(const std::string& msg) {
    std::string s;
    s += std::string("[ERROR] [") + get_curr_time_as_string() + std::string("]: ") + msg;
    std::cout << tColors.RED + s + tColors.NC << std::endl;
  }
  static void SUCCESS(const std::string& msg) {
    std::string s;
    s += std::string("[SUCCESS] [") + get_curr_time_as_string() + std::string("]: ") + msg;
    std::cout << tColors.GREEN + s + tColors.NC << std::endl;
  }

  static void STATUS(const std::string& msg) {
    std::string s;
    s += std::string("[STATUS] [") + get_curr_time_as_string() + std::string("]: ") + msg;
    std::cout << tColors.CYAN + s + tColors.NC << std::endl;
  }

  static void INFO(const std::string& msg) {
    std::string s;
    s += std::string("[INFO] [") + get_curr_time_as_string() + std::string("]: ") + msg;
